...
class AllVeneueAdaptervar (var mList: List<Today>,var mlistner: ListnerForNaviagtionItem) : RecyclerView.Adapter<AllVeneueAdaptervar.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind( list: List<Today>, listener: ListnerForNaviagtionItem, position: Int) {
