...
class AddServiceActvity : BaseActivity(), ListnerForCustomDialog, ListnerForDialog {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title="Add Services"
        ...
        mCompositeDisposable?.add(
            ApiRequestClient.createREtrofitInstance()
                .addServices(dataManager.getUserId()!!,mServiceId!!,
                    mSubServiceId!!,mServiceTime!!,mServicePrice!!,"")
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
